...
if(isset($_POST['addUser'])){
    ...
    $UserTable = mysqli_query($conn, "INSERT INTO `User`( `Fname`, `Lname`, `DateOfBirth`, `Role`, `Subject`, `Grade`) VALUES ('$fname','$lname','$dateOfBirth',$role,'$subject','$grade')");
    $LoginTable = mysqli_query($conn, "INSERT INTO `Login`(`Email`, `Password`) VALUES ('$email','$password')");
    if ($UserTable && $LoginTable){
